...
inpWidth = 416 #488 608     #Width of network's input image
inpHeight = 416 #488 608     #Height of network's input image
...
modelConfiguration = "cfg/custom-yolov4-tiny-detector_good.cfg";
modelWeights = "backup/custom-yolov4-tiny-detector_best_good.weights";
...
while cv.waitKey(1) < 0:
    ...
    label = "FPS: {0:.2f}".format(frame_rate_calc) 
